...
export const Route = createFileRoute("/terms")({
  ...
  head: () => ({
    meta: [
      { title: "Terms of Service — US LLC Formation" },
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <div className="prose prose-sm max-w-none space-y-6 text-muted-foreground">
            ...
            <section>
              ...
              <p>US LLC Formation provides LLC formation services, EIN acquisition, registered agent services, and related business formation assistance. We act as your authorized representative to file documents with state authorities and the IRS.</p>
            </section>
